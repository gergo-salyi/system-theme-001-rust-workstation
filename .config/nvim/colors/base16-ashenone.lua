...
-- Unused bg colors
local gui01 = "#282828" -- Lighter Background (Used for status bars, line number and folding marks)
local gui04 = "#b8b8b8" -- Dark Foreground (Used for status bars)
local gui06 = "#e8e8e8" -- Light Foreground (Not often used)
local gui07 = "#f8f8f8" -- Light Background (Not often used)

-- Selection background
local gui00 = "#181818" -- Default Background
local gui02 = "#383838" -- Selection Background

-- Foreground
local gui05 = "#bcd9ee" -- Default Foreground, Caret, Delimiters, Operators

local gui08 = "#f49052" -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
local gui09 = "#ad90fe" -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
local gui0A = "#d9d972" -- Classes, Markup Bold, Search Text Background
local gui0B = "#2ed368" -- Strings, Inherited Class, Markup Code, Diff Inserted
local gui0C = "#ed8eae" -- Support, Regular Expressions, Escape Characters, Markup Quotes
local gui0D = "#11b9ff" -- Functions, Methods, Attribute IDs, Headings
local gui0E = "#f49052" -- Keywords, Storage, Selector, Markup Italic, Diff Changed
local gui0F = "#ed8eae" -- Deprecated, Opening/Closing Embedded Language Tags

local gui03 = "#b5b5b5" -- Comments, Invisibles, Line Highlighting
...
vim.g.colors_name = "base16-ashenone-lua"
...
vim.api.nvim_set_hl(0, 'Error',        { fg = gui08,             ctermfg = cterm08                    })
vim.api.nvim_set_hl(0, 'ErrorMsg',     { fg = gui08,             ctermfg = cterm08                    })
vim.api.nvim_set_hl(0, 'Exception',    { fg = gui08,             ctermfg = cterm08                    })
vim.api.nvim_set_hl(0, 'FoldColumn',   { fg = gui0C,             ctermfg = cterm0C                    })
vim.api.nvim_set_hl(0, 'Folded',       { fg = gui03,             ctermfg = cterm03                    })
vim.api.nvim_set_hl(0, 'IncSearch',    { fg = gui09,             ctermfg = cterm09                    })
...
vim.api.nvim_set_hl(0, 'Search',       { fg = gui0A,             ctermfg = cterm0A                    })
vim.api.nvim_set_hl(0, 'Substitute',   { fg = gui0A,             ctermfg = cterm0A                    })
...
vim.api.nvim_set_hl(0, 'WildMenu',     { fg = gui08,             ctermfg = cterm08                    })
vim.api.nvim_set_hl(0, 'Title',        { fg = gui0D,             ctermfg = cterm0D                    })
vim.api.nvim_set_hl(0, 'Conceal',      { fg = gui0D,             ctermfg = cterm0D                    })
vim.api.nvim_set_hl(0, 'Cursor',       {             bg = gui05,                    ctermbg = cterm05 })
...
vim.api.nvim_set_hl(0, 'StatusLine',   { fg = gui04,             ctermfg = cterm04                    })
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = gui03,             ctermfg = cterm03                    })
vim.api.nvim_set_hl(0, 'VertSplit',    { fg = nil,   bg = nil,   ctermfg = nil,     ctermbg = nil     })
...
vim.api.nvim_set_hl(0, 'PMenu',        {             bg = gui02,                    ctermbg = cterm02 })
vim.api.nvim_set_hl(0, 'PMenuSel',     {             bg = gui00,                    ctermbg = cterm02 })
vim.api.nvim_set_hl(0, 'TabLine',      { fg = gui03,             ctermfg = cterm03                    })
...
vim.api.nvim_set_hl(0, 'GitGutterAdd',          { fg = gui0B, ctermfg = cterm0B })
vim.api.nvim_set_hl(0, 'GitGutterChange',       { fg = gui0D, ctermfg = cterm0D })
vim.api.nvim_set_hl(0, 'GitGutterDelete',       { fg = gui08, ctermfg = cterm08 })
vim.api.nvim_set_hl(0, 'GitGutterChangeDelete', { fg = gui0E, ctermfg = cterm0E })
